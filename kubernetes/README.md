...
```
$ docker image tag invoice aakil786/invoice
$ docker push aakil786/invoice
$ docker image tag notification aakil786/notification
$ docker push aakil786/notification
$ docker image tag store aakil786/store
$ docker push aakil786/store
```
